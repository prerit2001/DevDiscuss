    ...
    <div className={CommunityCard}>
      ...
      <div className={Facts}>
        <div style={{ display: "block", marginRight: "30px" }}>
          <div style={{ color: "#868686" }}>Threads</div>
          <div>📃 {props.Threads.length}</div>
        </div>
        <div style={{ display: "block", marginRight: "30px" }}>
          <div style={{ color: "#868686" }}>Users</div>
      ...
      <div className={Facts} style={{ textAlign: "left" }}>
        <div style={{ display: "block", marginRight: "30px" }}>
          <div style={{ color: "#868686" }}>Last Thread</div>
            ...
            <div>
              <img
                ...
                style={{
                  ...
                  marginRight: "20px",
                  borderRadius: "50%",
                  border: "3px solid #8479E1",
                }}
              />
            </div>
            <div>{lastthread.slice(0, 50)} ...</div>
          </div>
        </div>
      </div>
    </div>
