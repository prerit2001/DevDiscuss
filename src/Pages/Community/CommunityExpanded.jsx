      ...
      <div className={CommunityExpandedCover}>
        <div className={CommunityExpandedLeftHalf}>
          ...
          <div style={{ textAlign: "left" }}>
            ...
            software, or similar software whose source code is publicly
            available, is developed by an open-source software project. These
            are software products available with its source code under an
        ...
        <div className={CommunityExpandedRightHalf}>
          <div className="RowCover" style={{ marginLeft: "43%" }}>
